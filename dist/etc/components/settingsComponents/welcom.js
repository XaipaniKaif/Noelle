...
export default {
    ...
    createMessageWelcomTutorial() {
        const embed = new EmbedBuilder()
            ...
            .setColor('Blue')
            .setDescription(`Отправьте текст вашего приветственного сообщения для того, чтобы я могла его отправлять новым пользователям\n\n
    ...
    selectChannelWelcomTutorial() {
        ...
        const components = new ActionRowBuilder().addComponents(new ChannelSelectMenuBuilder()
